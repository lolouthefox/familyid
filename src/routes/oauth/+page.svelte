...
<main class="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-pink-50 to-pink-100">
	<div
	...
	>
		...
		{:else}
			<div class="w-full space-y-6">
				...
				{#if data.scopes}
					<div>
						<h2 class="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wide">Accès demandé</h2>
						<ul class="space-y-2">
